...
int main(int argc, char* argv[]) {
	...
	например мы хотим оставить только 1 строку. Нам нужно будет blocklengths[0] = 3; добавить количество столбцов и написать, что начинается с первого символа(displacements[0] = 0;)
	вот так получится
	1 2 3
	0 0 0
	0 0 0
	(с нулевого символа 3 символа)
 
	если мы хотим сделать например квадратик с 0 внутри то нам нужено 2 блока.
	1 -> 1,2,3,4; потом пропускаем 1 символ(5) и второй блок 2 -> 6,7,8,9
